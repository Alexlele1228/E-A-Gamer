    ...
    <main >
        ...
        <div style="max-height:300px;  overflow:hidden;">
            ...
            <div class="card-img-overlay">
              <h2 class="card-title">Welcome back !! <?php echo $currentName; ?>,</h2><br>
              <h4 class="card-text">Lets check some new game today.</h4><br><br><br>
              <h5 class="card-title">Banlance: $<?php echo $balance; ?></h5>
            </div>
          </div><hr><br>
