...
<div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
  ...
  <?php
  $THISSQL = "SELECT * FROM advanturegames ";
...
<!-- start of list -->
          ...
          <?php
             $newSQL = "SELECT * FROM advanturegames ";
             ...
             for($i=0;$i<$newResult->num_rows;$i++)
             {
              $categoriesRow = $newResult->fetch_assoc();
               echo "<li class=\"media\">
               <img src=".$categoriesRow["IMG"]." class=\"mr-3\" alt=\"...\">
               <div style=\"display:flex; flex-direction:column; justify-content:space-between \">
               <div >
                  <div class=\"media-body\">
                    <h1 class=\"mt-0 mb-1\">".$categoriesRow["Name"]."</h1> 
                    <p>".$categoriesRow["Description"]."</p>
                  </div>
                  <div style=\"align-self:flex-end; \">
                    <h4>$".$categoriesRow["Price"]."</h4>
                  </div>
               </div>
               <a href=\"item.php?id=".$categoriesRow["ID"]."&category=advanturegames\" style=\"  \">Deatil...</a>
               </div>
             </li>";
             }
